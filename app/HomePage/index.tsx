...
import SingleCore from "../Component/SingleCore";
            ...
            <Cover>
              ...
              <div className={styles.welcome}>
                ...
                <div className={styles.welcomeImg}>
                  <Image src="./images/welcome-img.png" height={200} width={1141} alt="welcome" className={styles.desktop} />
                  <Image src="./images/phonee.png" height={573} width={300} alt="welcome" className={styles.mobile} />
                </div>
              </div>
            </Cover>
          </div>
